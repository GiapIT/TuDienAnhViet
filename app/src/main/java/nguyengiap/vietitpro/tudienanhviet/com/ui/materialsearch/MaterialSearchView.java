...
import nguyengiap.vietitpro.tudienanhviet.com.ui.materialsearch.utils.AnimationUtil;

/**
 * @author Miguel Catalan Bañuls
 */
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener ,ICallSearch {
    ...
    private void initiateView() {
        ...
        initSearchView();
        View view=LayoutInflater.from(getContext()).inflate(R.layout.layout_header_listverb,null);
        mSuggestionsListView.addHeaderView(view);
    ...
    public void setVoiceSearch(boolean voiceSearch,ICallSearch iCallSearch) {
    ...
    public void setSuggestions(ArrayList<String> suggestions) {
        if (suggestions != null && suggestions.size() > 0) {
            ...
            final SearchAdapter adapter = new SearchAdapter(mContext, suggestions, suggestionIcon,this);
            setAdapter(adapter);
