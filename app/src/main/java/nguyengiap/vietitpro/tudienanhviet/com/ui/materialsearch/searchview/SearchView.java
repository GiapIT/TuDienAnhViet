...
public class SearchView extends FrameLayout implements View.OnClickListener { // Filter.FilterListener
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate((R.layout.search_view_master), this, true);
...
//            mBackImageView.setImageDrawable(ContextCompat.getDrawable(Application.getHKApplicationContext(),R.drawable.abs__ic_search_api_holo_light));
        }
