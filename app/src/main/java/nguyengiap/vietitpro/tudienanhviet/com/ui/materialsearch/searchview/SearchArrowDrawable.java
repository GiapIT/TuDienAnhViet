...
class SearchArrowDrawable extends Drawable {
    ...
    SearchArrowDrawable(Context context) {
        ...
        setBarThickness(context.getResources().getDimension(R.dimen.arrow_thickness));
        setSpinEnabled(true);
        setGapSize(Math.round(context.getResources().getDimension(R.dimen.arrow_gapBetweenBars)));
