 ...
 *
 */
public class AdaptetListFavorite extends RecyclerView.Adapter<AdaptetListFavorite.RadioViewHolder> {

    private Context context;
    private List<DictEntity> listVoca;

    public AdaptetListFavorite(Context context, List<DictEntity> listVoca) {
